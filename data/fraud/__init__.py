...
_DEFAULT_FRAUD_WEIGHTS = [3 / 41, 3 / 41, 3 / 41, 3 / 41, 7 / 41, 2 / 41, 2 / 41, 4 / 41, 3 / 41, 5 / 41, 2 / 41, 2 / 41, 2 / 41]


def _distribute_victims(num_selected: int, config: dict | None = None) -> list[int]:
    """Allocate num_selected across 13 patterns proportionally to weights from config."""
