...
def job_posting_scam(
    ...
    for sid in scammer_ids:
        ...
        events.append(make_event(
            ...
            metadata={"attack_pattern": "job_posting_scam", "job_id": job_id, "job_title": "Senior Engineer", "ip_country": "RU"},
        ))
        ...
        for vid in applicants:
            ...
            events.append(make_event(
                ...
                metadata={"attack_pattern": "job_posting_scam", "ip_country": "RU", "login_success": True},
            ))
            ts += timedelta(minutes=rng.randint(1, 5))
            counter += 1
            meta = {"attack_pattern": "job_posting_scam", "job_id": job_id, "ip_country": "RU"}
